#Nome:     Caio Guilherme Dos Santos Silva  RA: 10420097
#Nome:     Daniela Pereira Da Silva  RA: 10410906
#Nome:     Karina Nunes Da Silva RA: 10420693
.data
...
decoracao:            .asciiz "\n*****************************************************\n"
msg_invalido:         .asciiz "\n Número inválido. Por favor, insira números maiores que 0.\n"
...
valor_invalido:
    li $v0, 4
    la $a0, msg_invalido       # Aviso de invalidação
    syscall
...
main:
    ...
    c.eq.s $f18, $f19          # Verifica se o raio é igual a zero
    bc1t valor_invalido        # Se for zero, volta para a função de invalidação
